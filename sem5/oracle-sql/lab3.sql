...
FROM KOCURY JOIN FUNKCJE ON KOCURY.FUNKCJA = FUNKCJE.FUNKCJA FOR UPDATE OF PRZYDZIAL_MYSZY;
...
CREATE OR REPLACE PACKAGE PACK IS
    ...
    PROCEDURE AddBanda(nr_ban BANDY.NR_BANDY%TYPE, naz_ban BANDY.NAZWA%TYPE, ter BANDY.TEREN%TYPE);
END PACK;
